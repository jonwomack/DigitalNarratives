...
function begin() {
    let genre = document.getElementById("genreType").options[document.getElementById("genreType").selectedIndex].value;
    console.log(genre);
    /*
    ...
    */
    let models = firebase.database().ref('/models/' + genre + '/json');
